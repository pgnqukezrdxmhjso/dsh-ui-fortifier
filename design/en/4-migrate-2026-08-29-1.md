...
- package.json: removed dsh-client-runtime, added dsh-api-session-controller and dsh-client-ui-renderer.
- tsconfig references switched to session-controller/tsconfig.client.json, ui-renderer, core/session.
